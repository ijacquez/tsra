...
TS_EXPORT ts_ptr ts_mk_char(scheme *sc, char c);
...
TS_EXPORT void ts_put_char(scheme *sc, char c);
...
struct ts_interface {
  ...
  void (*set_in_port_file)(scheme *sc, FILE *fin);
  void (*set_in_port_str)(scheme *sc, char *start, char *past_the_end);
